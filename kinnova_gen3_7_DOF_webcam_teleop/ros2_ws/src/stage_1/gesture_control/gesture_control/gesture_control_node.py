...
class TwistTeleopNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('vel_scale_y',      1.5) # Lateral (left/right)
        self.declare_parameter('vel_scale_z',      1.5) # Vertical (up/down)
        self.declare_parameter('vel_scale_roll',   2.0) # Wrist rotation

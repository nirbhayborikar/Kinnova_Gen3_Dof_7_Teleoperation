...
class TwistTeleopNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('vel_scale_y',      2.5) # Lateral (left/right) #1.5
        self.declare_parameter('vel_scale_z',      2.5) # Vertical (up/down) #1.5
        self.declare_parameter('vel_scale_roll',   2.5) # Wrist rotation
